...
<div id="errorPageContainer">
    ...
    <div id="errorLongContent">
        ...
        <div id="errorShortDesc">
            <p id="errorShortDescText">Iceweasel can't find the server at www.127.0.0.1.com.</p>
        </div>
        ...
        <div id="errorLongDesc">
            <ul>
                ...
                <li>If your computer or network is protected by a firewall or proxy, make sure
                    that Iceweasel is permitted to access the Web.</li>
            </ul>
        </div>
    ...
    <div id="certificateErrorReporting">
        <a id="showCertificateErrorReportingPanel" href="#">Report this error<span class="downArrow"> ▼</span></a>
    </div>
    ...
    <div id="certificateErrorReportingPanel">
        ...
        <div id="errorStatePanel">
            ...
            <button id="reportCertificateError">Report</button>
                <a style="display: none;" href="blog.php">Volver</a>
            <span id="reportSendingMessage" style="display: none;">Sending report</span>
            <span id="reportSentMessage" style="display: none;">Report sent</span>
          </span>
        </div>
    </div>
